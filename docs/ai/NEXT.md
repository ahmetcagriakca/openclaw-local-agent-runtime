...
**Key artifacts:** `generate-review-packet.py`, `check-stale-refs.py`, `generate-archive-manifest.py`, `closure-preflight.yml`, `check-merged-state.py`, `cleanup-merged-branches.sh`
