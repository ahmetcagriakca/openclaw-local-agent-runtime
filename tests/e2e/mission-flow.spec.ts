...
test.describe('Live Mission E2E Flow', () => {
  test('mission lifecycle: list → create → detail → stages', async ({ request }) => {
    ...
    expect(listBody).toHaveProperty('missions');
    ...
    expect(capsBody).toHaveProperty('capabilities');
    ...
    expect(healthBody).toHaveProperty('components');
    ...
    expect(telemetryBody).toHaveProperty('events');
    ...
    expect(approvalsBody).toHaveProperty('approvals');
